...
class Users extends CI_Controller
{
	...
	public function list_excel()
	{
		...
		$this->phpexcel->getProperties()->setCreator('CoderzWar')
			->setLastModifiedBy('CoderzWar')
			->setTitle('CoderzWar Users')
			->setSubject('CoderzWar Users')
			->setDescription('List of CoderzWar users ('.$now.')');

		// Name of the file sent to browser
		$output_filename = 'coderzwar_users';
